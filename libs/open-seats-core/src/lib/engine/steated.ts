...
import { KonvaOutput, SeatedSaveData, SeatedSeatSaveData, SeatedTableSaveData } from '../models';
...
export class Seated {
	...
	public export(): SeatedSaveData {
		const konva: KonvaOutput = this._konvaMediator.export();
		const exports: { seats: SeatedSeatSaveData[]; tables: SeatedTableSaveData[] } = this._seatMediator.export();
		return {
			...exports,
